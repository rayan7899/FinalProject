...
@section('content')
    ...
    <div class="container-fluid px-5">
        ...
        <div class="row justify-content-center" id="section2" style="display: none">
            <div class="col-sm-5 p-0">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <h6 class="d-inline col-4">المقررات</h6>
                            <select required name="program" id="program" class="form-controller col-4" onchange="getMajors()">
                                <option value="" disabled selected>حدد البرنامج</option>
                                <option value="1">بكالوريوس</option>
                                <option value="2">دبلوم</option>
                            </select>
                            <select required name="major" id="major" class="form-controller col-4" onchange="getCourses()">
            ...
            <div class="col-2 d-none d-md-block p-0">
                <div class="row justify-content-center mt-2">
                    <a href="#" onclick="addCourseToStudentTable()"
