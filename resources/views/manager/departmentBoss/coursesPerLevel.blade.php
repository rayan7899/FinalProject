                ...
                <div class="col">
                    <div class="form-row mb-3">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select required name="major" id="major" class="form-control w-100" onchange="fillCourses()">
                                <option value="0" disabled selected>أختر</option>
                            </select>
                            @error('major')
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-inline float-left">
                                <a onclick="window.showStudent()" class="btn btn-sm btn-primary" href="#" role="button">عرض
                                    بيانات المتدربين</a>
                            </div>
                        </div>
                        <div class="card-body p-0">
