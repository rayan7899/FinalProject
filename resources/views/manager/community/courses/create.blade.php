                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="theoretical_hours" type="number"
                                    ...
                                    name="theoretical_hours" value="{{ old('theoretical_hours') }}" required autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="practical_hours" type="number"
                                    ...
                                    name="practical_hours" value="{{ old('practical_hours') }}" required autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="exam_theoretical_hours" type="number"
                                    ...
                                    name="exam_theoretical_hours" value="{{ old('exam_theoretical_hours') }}" required
                                    autofocus>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="exam_practical_hours" type="number"
                                    ...
                                    name="exam_practical_hours" value="{{ old('exam_practical_hours') }}" required
                                    autofocus>
