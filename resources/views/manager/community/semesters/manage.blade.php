...
@section('content')
    <div class="container">
        ...
        @endif
        <div class="card">
            <div class="card-header h5">{{ __('ادارة الفصل الدراسي') }}</div>
            <div class="card-body p-0 px-5">
                <div class="p-2">
                    <a href="{{ route('newSemester') }}" class="btn btn-outline-primary p-3 m-2"
                        style="font-size: 16px; width: 220px;">فصل دراسي جديد</a>
        ...
        function openModal() {
            ...
            Swal.fire({
                ...
                html: `
                            ...
                            `,
                confirmButtonText: '@if ($semester->can_request_hours) ايقاف @else اتاحة @endif',
