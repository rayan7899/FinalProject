            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" onclick="showContract()">طباعة</button>
                    </div>
                </div>
            </div>
        </div>

        <div dir="ltr" class="modal fade" id="contractModal" data-backdrop="true" tabindex="-1" role="dialog" aria-labelledby="contractModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div dir="rtl" class="modal-header">
                    ...
                    <div dir="rtl" class="modal-body p-0">
                        <iframe id="contractFram" src="" frameborder="0" class="w-100 p-0 m-0" style="min-height: 400px"></iframe>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary mr-auto" data-dismiss="modal">الغاء</button>
